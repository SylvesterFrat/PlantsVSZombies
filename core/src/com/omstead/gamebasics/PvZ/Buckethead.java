...
public class Buckethead extends BaseZombie implements IShootable{
    private int health;
    ...
    public Buckethead(int x, int y) {
        setZombieTexture(new Texture("bucketHead.png"));
    ...
    public void freeze() {
        getZombie().setTexture(new Texture("bucketHeadFrozen.png"));
