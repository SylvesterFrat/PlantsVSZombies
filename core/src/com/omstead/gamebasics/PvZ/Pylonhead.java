...
public class Pylonhead extends BaseZombie implements IShootable{
    private int health;
    ...
    public Pylonhead(int x, int y) {
        setZombieTexture(new Texture("pylonHead.png"));
    ...
    public void freeze() {
        getZombie().setTexture(new Texture("pylonHeadFrozen.png"));
